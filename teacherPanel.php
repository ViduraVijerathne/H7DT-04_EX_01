                ...
                <div class="col-12 bg-white ">
                    <div class="row">
                        ...
                        <div class="col-10 d-flex justify-content-end">
                            ...
                            <p>
                                <button class="btn btn-outline-dark m-2 d-flex flex-column" type="button" onclick="LoadTeacherNotification()" data-bs-toggle="collapse" data-bs-target="#NotificationCard" aria-expanded="false" aria-controls="collapseWidthExample">
            ...
            <div class="row ">
                ...
                <div class="col-2 bg-white shadow " style="height:100vh;">
                    ...
                    <div class="row p-1  pe-3 ps-3 mt-5 ">
                        <button class="btn btn-dark text-capitalize fw-bold" id="btn_t_home" onclick="t_btn_nav('home')">Home</button>
                    </div>
                    <div class="row mt-1 pe-3 ps-3">
                        <button class="btn btn-outline-dark text-capitalize fw-bold" id="btn_t_AddLessons" onclick="t_btn_nav('AddLessons')">Add Lesson Notes</button>
                    </div>

                    <div class="row mt-1 pe-3 ps-3">
                        <button class="btn btn-outline-dark text-capitalize fw-bold" id="btn_t_AddAsigment" onclick="t_btn_nav('AddAsigment')">Add Asigment</button>
                    </div>
                    <div class="row mt-1 pe-3 ps-3">
                        <button class="btn btn-outline-dark text-capitalize fw-bold" id="btn_t_AnswerSheet" onclick="t_btn_nav('AnswerSheet')">AnswerSheets</button>
                    </div>
