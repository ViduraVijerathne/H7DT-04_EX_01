    ...
    <div class="row">
        ...
        <div class="col-12 sticky-top">
            <Div class="row bg-body">
                <div class="col-12 fw-bold fs-3 text-center"> Add New Lesson Note</div>
                <Div class="col-2">
                ...
                <div class="col-2">
                    <button class="btn btn-success" onclick="AddLesson()" >ADD Lesson</button>
                </div>
            </Div>
        </div>
        ...
        <div class="col-12 mt-2 mb-5">
            ...
            $rs = Teacher_q::GetAllLessonsNoteByTeacherEmail(Access::$email);
            $n  = $rs -> num_rows;
            if($n > 0){
                for ($x = 0; $x < $n; $x++) {
                    $d = $rs -> fetch_assoc();
